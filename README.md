Jammming by Ben Siegfried

This is a React application written for the CodeAcademy.com's [Build Front-End Web Applications](https://www.codecademy.com/pro/intensive/build-frontend-web-apps-from-scratch) from Scratch Pro Intensive course.
...
Remove Song from Custom Playlist — users can remove a track from their playlist by selecting a - sign on the right side of the track's 
display container.
